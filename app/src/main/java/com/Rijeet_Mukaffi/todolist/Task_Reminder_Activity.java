...
import com.Rijeet_Mukaffi.todolist.reminder.AlarmScheduler;
...
public class Task_Reminder_Activity extends AppCompatActivity implements
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                if (!mVehicleHasChanged) {
                    NavUtils.navigateUpFromSameTask(Task_Reminder_Activity.this);
                    return true;
                }
